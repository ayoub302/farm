          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <div className="flex items-center gap-3 border-s border-gray-200 ps-6">
                ...
                <Link
                  href="/reservation"
                  className="bg-green-600 text-white px-5 py-2 rounded-full text-sm font-bold hover:bg-green-700 transition flex items-center gap-2 whitespace-nowrap"
                >
                  <FaCalendarAlt />
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-b border-gray-200 animate-fade-in-down z-[999] relative">
          <div className="px-4 pt-2 pb-6">
            ...
            {/* Botones en COLUMNA para móvil - MEJOR VISUALIZACIÓN */}
            <div className="flex flex-col gap-3">
              {/* Botón Admin - Tamaño grande */}
              <div className="w-full">
                <AdminButton isMobile={true} />
              </div>

              {/* Botón Réserver une activité - Tamaño grande */}
              <div className="w-full">
                <Link
                  href="/reservation"
                  onClick={() => setIsMenuOpen(false)}
                  className="flex items-center justify-center gap-2 bg-green-600 text-white px-4 py-4 rounded-xl font-bold hover:bg-green-700 transition w-full text-base"
                >
